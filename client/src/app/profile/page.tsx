...
const farmerData = {
  personal: {
    name: "Rajith Kumara",
    avatar:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/MacBook%20Air%20-%201.jpg-OTMbzxXeSzVP354fCu4T8iSbavU7xD.jpeg",
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="crops" className="space-y-6">
          ...
          <Card>
            ...
            <CardFooter>
              <Button className="bg-green-600 hover:bg-green-700">Add New Crop</Button>
            </CardFooter>
          </Card>
